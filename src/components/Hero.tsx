      ...
      <div className="relative z-10 container mx-auto px-4 text-center text-white">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="space-y-3 md:space-y-4">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold opacity-90">
              O Mapa para Fora da Prisão Invisível
            </h2>
            <p className="text-lg sm:text-xl md:text-2xl opacity-80 font-light px-4 sm:px-0">
          ...
          <div className="space-y-4 md:space-y-6 pt-6 md:pt-8">
            <p className="text-base sm:text-lg md:text-xl max-w-3xl mx-auto opacity-90 px-4 sm:px-0 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 px-4 sm:px-0">
              <Button 
                variant="liberation" 
                size="xl" 
                className="min-w-[280px] h-12 sm:h-14 text-base sm:text-lg"
